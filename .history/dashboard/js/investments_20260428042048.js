...
// ── HOOK INTO EXISTING onSnapshot ─────────────
// Find the existing onSnapshot call in your investments.js
// Inside it, after:   invSetEl("invRefCode", code);
// ADD this one line:  loadPremRefStats(d, user.uid);
//
// That's the only connection needed — the rest is self-contained above.
