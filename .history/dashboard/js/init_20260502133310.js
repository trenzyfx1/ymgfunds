...
// If redirected back to login with ?suspended=1 — show the banner
// This runs on the login page itself
  ...
  window.addEventListener("DOMContentLoaded", () => {
    ...
    banner.innerHTML = `
      ...
      <div>
        ...
        <a href="../h" style="font-size:0.8rem;color:#dc2626;font-weight:700;text-decoration:underline;">
