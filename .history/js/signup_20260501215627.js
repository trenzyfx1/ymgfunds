...
document.getElementById("createBtn").addEventListener("click", async () => {
  ...
  btn.disabled     = true;
  text.textContent = "Checking details...";
  icon.className   = "fa-solid fa-spinner fa-spin";

  try {
    const phoneUsed = await isPhoneAlreadyUsed(phone);
    if (phoneUsed) {
      showError("phone", "phoneError", "This phone number is already linked to an account.");
      btn.disabled     = false;
